...
namespace Japool\Genconsole\Eloquent\ormCache\Traits;

use Japool\Genconsole\Eloquent\ormCache\FlushQueryCacheObserver;
use Japool\Genconsole\Eloquent\ormCache\Query\Builder;
